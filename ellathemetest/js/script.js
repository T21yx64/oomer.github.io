...
$(document).ready(function() {
 ...
 $(document).on("click",".collapse-icon", function(){
    $("#sidebar_banner").addClass("hide");
    $(".icon_show_banner").addClass("show");
    $("#documenter_content").addClass("hide_banner");
    $(".icon_show_banner").removeClass("show_banner");
 	$("#sidebar_banner").removeClass("show_banner");
  });
 $(document).on("click",".icon_show_banner", function(){
 	$(".icon_show_banner").addClass("show_banner");
 	$("#sidebar_banner").addClass("show_banner");
    $("#sidebar_banner").removeClass("hide");
    $(".icon_show_banner").removeClass("show");
    $("#documenter_content").removeClass("hide_banner");
  });